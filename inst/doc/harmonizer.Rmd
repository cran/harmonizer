...
<ol type="a">
  ...
  <li>A data frame that is based on the entered firm data. The entered firm data data is extended by harmonized data (that is _CN8plus_, _flag_, _flagyear_, _HS6plus_, _BEC_, _BEC\_agr_, _BEC\_basic\_class_).</li>
</ol>
